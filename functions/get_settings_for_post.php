<?php
$sql = "SELECT header_text_color_settings,header_position_settings,header_image_uri_settings,header_image_settings,blog_name_settings,active_footer_settings,active_aside_settings  FROM rob_settings WHERE active_settings = 1";
    foreach ($conn->query($sql) as $row){
        ...
        $active_footer_social_settings = $row['active_footer_settings'];
