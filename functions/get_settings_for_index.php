<?php
$sql = "SELECT header_text_color_settings,header_position_settings,header_image_uri_settings,header_image_settings,blog_name_settings,active_footer_settings FROM rob_settings WHERE active_settings = 1";
